...
function ScreenSource(props) {
  ...
  useEffect(() => {
    const APIResultsLoading = async() => {
      ...
      const data = await fetch(`https://newsapi.org/v2/sources?language=${langue}&country=${country}&apiKey=262b1d41934e4229b9dd3e4999a0bfd8`)
  ...
  return (
    <div>
       ...
       <div style={{display:'flex', justifyContent:'center', alignItems:'center'}} className="Banner">
          ...
          <img style={{width:'40px', margin:'10px',cursor:'pointer'}} src='/images/es.png' onClick={() => setSelectedLang('es')} /> 
        </div>
